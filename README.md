Business Scenario
It has been discovered that a lot of properties the business manages may have missing or faulty smoke alarms. As such, teams were sent out to check the alarms, the outcome of which has been displayed in a Power BI dashboard. The primary function of the dashboard is to show the repairs team which properties need to have follow up work, and to enable the team leaders to capture that data in the dashboard itself. The dashboard writeback is a relatively new functionality, powered by Microsoft Fabrtic tools such as translytical flows and Fabric SQL database. This opens up a world of possibilities, as up to this point, the only way to implement writeback was through Power Apps integrations, which had huge licensing costs. The new technique reduces cost, is easier to implement, manage and track changes, while also being more flexible.
